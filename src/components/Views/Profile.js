			...
			<div className="container pt-9 pb-9">
				<div className="row">
					<div className="col-md-4">
						<img src="/img/mary.jpg" alt="userimage" className="img-fluid mb-4"/>
						<hr/>
					...
					<div className="col-md-8 pl-3 pl-md-6 pt-4 pt-md-0">
						...
						<p className="small"><i className="fas fa-map-marker-alt"></i> {props.address}</p>
...
const mapStateToProps = (state) => {
	return {
		...
		address: state.currentLocation.name
	}
}
